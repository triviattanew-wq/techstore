        ...
        <div className="container-custom py-6 md:py-8">
            ...
            <div className="flex items-center gap-3">
              <div className="relative">
                <select
                  ...
                  className="appearance-none bg-white border border-gray-200 rounded-xl px-4 py-2.5 pr-10 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-primary-500"
                >
                  {sortOptions.map(opt => (
              ...
              <button
                ...
                className="md:hidden flex items-center gap-2 px-4 py-2.5 bg-white border border-gray-200 rounded-xl text-sm text-gray-900"
              >
          ...
          <div className="flex gap-6 md:gap-8">
            ...
            <aside className="hidden md:block w-64 flex-shrink-0">
              <div className="bg-white rounded-2xl p-5 sticky top-24 border border-gray-200">
                ...
                {/* Brands */}
                <div className="mb-6">
                  <h4 className="text-sm font-medium text-gray-900 mb-3">Бренды</h4>
                  <div className="space-y-2">
                    {brands.map(brand => (
                ...
                {memoryOptions.length > 0 && (
                  <div className="mb-6">
                    <h4 className="text-sm font-medium text-gray-900 mb-3">Память</h4>
                ...
                <div className="space-y-2">
                  ...
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      ...
                      className="w-4 h-4 rounded border-gray-300 text-primary-600 focus:ring-primary-500"
                    />
                    <span className="text-sm text-gray-600">Новинки</span>
                  </label>
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      type="checkbox"
                      ...
                      className="w-4 h-4 rounded border-gray-300 text-primary-600 focus:ring-primary-500"
                    />
                    <span className="text-sm text-gray-600">Хиты продаж</span>
                  </label>
                </div>
              </div>
            </aside>
                    ...
                    <div className="flex justify-center mt-8">
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          disabled={page === 1}
                          className="px-4 py-2 border border-gray-200 rounded-lg text-sm text-gray-900 bg-white disabled:opacity-50"
                        >
                          Назад
                        </button>
        ...
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          <div className="absolute bottom-0 left-0 right-0 bg-white rounded-t-3xl max-h-[85vh] overflow-y-auto">
            <div className="sticky top-0 bg-white border-b border-gray-100 p-4 flex items-center justify-between">
              <h3 className="font-semibold text-lg text-gray-900">Фильтры</h3>
            ...
            <div className="p-4 space-y-6">
              {/* Brands */}
              <div>
                <h4 className="font-medium mb-3 text-gray-900">Бренды</h4>
                <div className="space-y-2">
                  {brands.map(brand => (
                    <label key={brand.id} className="flex items-center gap-2 cursor-pointer">
                      <input
              ...
              {/* Price */}
              <div>
                <h4 className="font-medium mb-3 text-gray-900">Цена</h4>
                <div className="flex items-center gap-3">
                  <input
                    type="number"
                    value={priceRange[0]}
                    onChange={(e) => setPriceRange([Number(e.target.value), priceRange[1]])}
                    className="flex-1 px-4 py-3 border border-gray-200 rounded-xl bg-white text-gray-900"
                    placeholder="От"
                  />
                  <input
                    type="number"
              ...
              {memoryOptions.length > 0 && (
                <div>
                  <h4 className="font-medium mb-3 text-gray-900">Память</h4>
                  <div className="flex flex-wrap gap-2">
                    {memoryOptions.map(memory => (
                      <button
                        key={memory}
            ...
            <div className="sticky bottom-0 bg-white border-t border-gray-100 p-4 flex gap-3">
              <button
                onClick={clearFilters}
                className="flex-1 py-3 border border-gray-200 rounded-full text-sm font-medium text-gray-900 hover:bg-gray-50"
              >
                Сбросить
              </button>
              <button
                onClick={() => setIsFilterOpen(false)}
                className="flex-1 py-3 bg-gray-900 text-white rounded-full text-sm font-medium"
              >
